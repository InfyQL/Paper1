...
Data provided from the City of Toronto via the 'opendatatoronto' package, [@citeopendatatoronto] and R language [@citeR], along with tidyverse [@citetidyverse], knitr [@citeknitr], and dplyr [@citedplyr] for document construction and producing tables and figures used.
